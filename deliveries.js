...
const deliveries = [
  {
    ...
    shipper: {
      name: "WYCON",
      phone: "+44 7832933672",
      address: "Corso Vittorio Emanuele II, 4, 20122 Milano MI, Italy",
      email: "novashippinglogistics.agency@gmail.com"
    },
    receiver: {
      name: "Yiseli Rosario",
      phone: "+13054565577",
      address: "Florida ep-121231 2160 NW 135th Ave 33182-1930",
      email: "rosariocruzmelisa@hotmail.com"
    },
    shipment: {
      weight: "4.5 kg",
      courier: "Nova",
...
events: [
  {
    ...
    details: "Order processed and export documentation prepared (Wycon Cosmetics, Italy)"
  },
  {
    time: "2025-12-15T22:10:00Z",
    status: "Departed origin facility",
    location: "Milan Malpensa Airport (MXP) – International Cargo Terminal",
    coords: [45.6301, 8.7231],
    details: "Shipment handed over to air carrier for international transport"
  },
  {
    time: "2025-12-15T06:45:00Z",
    status: "On the air — In transit",
    location: "En route to United States (Florida)",
    coords: [41.0, -30.0],
    details: "Aircraft en route from Milan (MXP) to Miami International Airport (MIA)"
  }
]
  ...
  {
    trackingCode: "AE99887766",
    estimatedDelivery: "2025-12-05T14:00:00Z",
    customs: "Pending",
    shipper: {
      name: "-",
      phone: "-",
    ...
    receiver: {
      name: "Madison Burley",
      phone: "+14257657623",
      address: "8050 Mukiltro speedway unit 1424",
      email: "lilyesthetics@gmail.com"
    },
    shipment: {
      weight: "5.6 kg",
      courier: "DHL Express",
  ...
  events: [
  {
    ...
    status: "Shipment information received",
    location: "Los Angeles International Airport (LAX), California, USA",
    coords: [33.9416, -118.4085],
    details: "Label created and package loaded for cargo flight"
  },
  {
    time: "2025-12-06T11:00:00Z",
    status: "Arrived at destination airport",
    location: "Paine Field / Snohomish County Airport (PAE), Everett, WA, USA",
    coords: [47.9061, -122.2823],
    details: "Package arrived at Washington airport, ready for local delivery"
  }
]
...

  {
    ...
    receiver: {
      name: "Nina Uhi",
      phone: "+447951573500",
      address: "28 B Westwick Gardens W14BU London",
      email: "ninauhl@hotmail.de"
    },
    shipment: {
      weight: "8.0 kg",
      courier: "DHL Express",
 ...
 events: [
  {
    time: "2025-12-03T11:00:00Z",
    status: "Shipment information received",
    location: "London Heathrow Airport (LHR), London, UK",
    coords: [51.4700, -0.4543],
    details: "Label created and package ready for shipment"
  },
  {
    time: "2025-12-05T14:00:00Z",
    status: "Delivered",
    location: "28 B Westwick Gardens, London W14 8BU, UK",
    coords: [51.4945, -0.2038],
